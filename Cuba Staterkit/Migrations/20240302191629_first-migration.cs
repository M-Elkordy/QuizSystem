        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SessionTable_SubjectTable_SubjectID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HomeWorks_SessionTable_SessionID",
                        column: x => x.SessionID,
                        principalTable: "SessionTable",
                        principalColumn: "ID");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Quizes_SessionTable_SessionID",
                        column: x => x.SessionID,
                        principalTable: "SessionTable",
                        principalColumn: "ID");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnswersURL = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SessionTable_SubjectID",
                table: "SessionTable",
                column: "SubjectID");
        }
